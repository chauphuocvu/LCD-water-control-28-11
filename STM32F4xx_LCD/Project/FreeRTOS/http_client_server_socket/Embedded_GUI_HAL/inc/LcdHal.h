...
#define GL_BBLue              BRIGHTBLUE
#define GL_BGreen             BRIGHTGREEN
#define GL_BCyan              BRIGHTCYAN
#define GL_BRed               BRIGHTRED
#define GL_BMagenta           BRIGHTMAGENTA
#define GL_BYellow            BRIGHTYELLOW
#define GL_Blue               BLUE
#define GL_Green              GREEN
#define GL_Cyan               CYAN
#define GL_Red                RED
#define GL_Magenta            MAGENTA
#define GL_Brown              BROWN
#define GL_LGray              LIGHTGRAY
#define GL_DGray              DARKGRAY
#define GL_LBlue              LIGHTBLUE
#define GL_LGreen             LIGHTGREEN
#define GL_LCyan              LIGHTCYAN
#define GL_LRed               LIGHTRED
#define GL_LMagenta           LIGHTMAGENTA
#define GL_Yellow             YELLOW

#define GL_Grey								DARKGRAY

#define GL_Gray0              GRAY0
#define GL_Gray1              GRAY1
#define GL_Gray2              GRAY2
#define GL_Gray3              GRAY3
#define GL_Gray4              GRAY4
#define GL_Gray5              GRAY5
#define GL_Gray6              GRAY6
