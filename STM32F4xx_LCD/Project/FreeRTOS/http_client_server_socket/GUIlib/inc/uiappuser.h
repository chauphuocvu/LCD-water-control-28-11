...
/**
  ...
  * @retval None
  */
void screen_dos_button_Click(void);
void back_to_setting_back_dos_button_Click(void);
void back_to_home_screen_back_button_dos_Click(void);
...
/**
  ...
  * @retval None
  */
void screen1_DesignOptionButton03_Selected(void);
...
void back_to_home_screen_back_button_Click(void);
